    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold text-center text-primary font-poppins mb-4">
          Submit Your Template to Tempa123
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <p className="mt-6 text-sm text-gray-500">
              Our team will review your submission within 5-7 business days. For questions, please contact us at <a href="mailto:info@tempa123.com" className="text-primary hover:underline">info@tempa123.com</a>.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
              <p className="text-gray-700 font-semibold">Embedded Google Form</p>
              <p className="text-gray-500 mt-2">
                A Google Form for template submissions would be embedded here, containing fields for:
              </p>
              <ul className="text-sm text-left list-disc list-inside mt-4 text-gray-600">
                <li>Name & Email</li>
