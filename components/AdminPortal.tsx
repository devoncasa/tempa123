    ...
    return (
        <div className="w-64 bg-grey-900 text-white flex flex-col flex-shrink-0">
            <div className="flex items-center justify-center h-20 border-b border-gray-700">
                <img src="https://raw.githubusercontent.com/devoncasa/Tempa123-Asset/refs/heads/main/Tempa%20logo%20small%20fit%20(1).webp" alt="Logo" className="h-10 w-auto brightness-0 invert" />
            </div>
